...
ggsave(plot=plot.par,device = "pdf",filename ="Plots/plots_parameters_cul.pdf",dpi = "retina",height = 8,width = 10)
ggsave(plot=plot.par,device = "png",filename ="Plots/plots_parameters_cul.png",dpi = "retina",height = 8,width = 10,bg = "white")
```
