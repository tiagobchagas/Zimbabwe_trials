...
stvc_env <- stvc |>  select(H2, CV, trait, env, geno_sig, envs,year,H2_em,H2_cul) |> pivot_longer(cols=c(H2,CV,H2_em,H2_cul)) |>  
...
stvc_year <- stvc |>  select(H2, CV, trait, env, geno_sig, envs,year,H2_em,H2_cul) |> pivot_longer(cols=c(H2,CV,H2_em,H2_cul)) |>  
...
ggsave(plot=plot.par,device = "pdf",filename ="Plots/plots_parameters.pdf",dpi = "retina",height = 10,width = 12)
ggsave(plot=plot.par,device = "png",filename ="Plots/plots_parameters.png",dpi = "retina",height = 10,width = 12,bg = "white")
```
