...
head(varcomp)
View(varcomp)
varcomps <- varcomp |> mutate(effect=recode(effect,"rep"="R", "geno"="V", "LOCATION_NAME"="L","geno:LOCATION_NAME"="VxL",
