...
library(kableExtra)
rbind(outs_PH$variances,outs_PH$variances,outs_PL$variances) |> kable(format = "html", booktabs = TRUE, longtable=TRUE)
```
...
library(RColorBrewer)
RColorBrewer::brewer.pal(n=2,name = "Set1")
display.brewer.all(n=2)
