...
ggsave(plot=stvclp,device = "pdf",filename ="Plots/individual_analysis.pdf",dpi = "retina",height = 8,width = 10)
ggsave(plot=stvclp,device = "png",filename ="Plots/individual_analysis.png",dpi = "retina",height = 8,width = 10,bg = "white")
